...
\item \textbf{多行的情况}，如果有多行，我的意思是，真的有很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行很多行。
\end{itemize}
...
% Translated Article
\blankmatter
\includepdf[pages=-, scale=0.95, pagecommand={}]{docs/translation.pdf}
%\centering
